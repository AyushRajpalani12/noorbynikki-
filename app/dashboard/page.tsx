  ...
  return (
    <div className="min-h-screen bg-[#3A0E1F] flex flex-col lg:flex-row">
      ...
      <main className="flex-1 lg:ml-64 bg-[#FAF6F0] flex flex-col">
        ...
        {/* Top bar - Added pl-16 on mobile to completely avoid overlapping with the hamburger menu button */}
        <div className="fixed top-0 left-0 right-0 lg:left-64 z-30 h-16 flex items-center justify-between bg-[#FAF6F0]/95 backdrop-blur border-b border-[#EFE6DA] pl-16 pr-4 sm:px-6">
          ...
          {/* Left side: Menu button & Title wrapper with proper spacing */}
          ...
          {/* Right side: Email & Avatar */}
          <div className="flex items-center gap-2.5 shrink-0">
            <span className="text-xs text-[#8B7E74] hidden sm:inline truncate max-w-[160px]">
              {user.email}
            </span>
            <div className="w-8 h-8 rounded-full bg-[#3A0E1F] text-[#E9DAC1] flex items-center justify-center text-xs font-serif font-semibold shadow-sm shrink-0">
